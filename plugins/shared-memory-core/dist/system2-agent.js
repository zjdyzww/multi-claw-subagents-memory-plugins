...
export class System2Agent extends EventEmitter {
    agentId;
    role = 'system2';
    agentType;
    _status;
...
// 导出工厂函数
export function createSystem2Agent(agentId, agentType) {
    return new System2Agent(agentId, agentType);
}
//# sourceMappingURL=system2-agent.js.map